    ...
    public class AutofacBootStrapper
    {
        public class AutofacModuleRegister : Autofac.Module
        {
            ...
            protected override void Load(ContainerBuilder builder)
            {
                ...
                builder.RegisterAssemblyTypes(GetAssemblyByName("BISM.OS.Service")).Where(a => a.Name.EndsWith("Service")).AsImplementedInterfaces();

                // 注册Repository中的对象,Repository中的类要以Repository结尾，否则注册失败
                builder.RegisterAssemblyTypes(GetAssemblyByName("BISM.OS.Repository")).Where(a => a.Name.EndsWith("Repository")).AsImplementedInterfaces();
            }
